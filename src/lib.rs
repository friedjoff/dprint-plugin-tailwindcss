...
use dprint_core::plugins::{
    FormatResult, PluginInfo, PluginResolveConfigurationResult, SyncFormatRequest,
...
impl SyncPluginHandler<Configuration> for TailwindCssPluginHandler {
    fn plugin_info(&mut self) -> PluginInfo {
        PluginInfo {
            ...
            update_url: Some(
                "https://plugins.dprint.dev/friedjoff/dprint-plugin-tailwindcss/latest.json"
                    .to_string(),
            ),
        }
    }
